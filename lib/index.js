...
exports.initSign = exports.createKeys = exports.shakeBufSize = exports.nonceSize = exports.PUBKEY_SIZE = exports.SIG_MAX = exports.PRIVKEY_SIZE = void 0;
...
exports.initSign = (shakeMsg, nonce) => {
    ...
    let i;
    i = node_falcon_stream_2.startSign(shakeCon, nonce, shakeMsg);
    return i;
};
